...
const AdminWildlifeGardeningPage = () => {
  ...
  return (
    <div>
      ...
      {modalOpen && <SimpleFormModal title="Wildlife Gardening" table="wildlife_gardening_entries" storagePath="wildlife" imageField="image_url" fields={FIELDS} record={editing} onClose={() => { setModalOpen(false); setEditing(null); }} onSaved={() => { setModalOpen(false); setEditing(null); fetch_(); }} />}
