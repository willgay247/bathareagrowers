...
const AdminFarmsPage = () => {
  ...
  return (
    <div>
      ...
      {modalOpen && <SimpleFormModal title="Farm" table="farms" storagePath="farms" imageField="image_url" fields={FIELDS} record={editing} onClose={() => { setModalOpen(false); setEditing(null); }} onSaved={() => { setModalOpen(false); setEditing(null); fetch_(); }} />}
