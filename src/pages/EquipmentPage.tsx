...
const EquipmentPage = () => (
  <main>
    <section className="relative flex h-[40vh] md:h-[60vh] w-full items-center justify-center overflow-hidden">
      <img src={imageUrl("IMG_3759.webp", { width: 1200, quality: 75 })} alt="Shared growing equipment" className="absolute inset-0 w-full h-full object-cover" loading="eager" decoding="async" />
