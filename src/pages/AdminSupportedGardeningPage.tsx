...
const AdminSupportedGardeningPage = () => {
  ...
  return (
    <div>
      ...
      {modalOpen && <SimpleFormModal title="Supported Gardening" table="supported_gardening" storagePath="supported" imageField="image_url" fields={FIELDS} record={editing} onClose={() => { setModalOpen(false); setEditing(null); }} onSaved={() => { setModalOpen(false); setEditing(null); fetch_(); }} />}
