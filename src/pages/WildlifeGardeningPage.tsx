  ...
  return (
    <main>
      ...
      <section className="relative flex h-[40vh] md:h-[60vh] w-full items-center justify-center overflow-hidden">
        <img src={imageUrl("IMG_3679.webp", { width: 1200, quality: 75 })} alt="Wildlife gardening in Bath" className="absolute inset-0 w-full h-full object-cover" loading="eager" decoding="async" />
