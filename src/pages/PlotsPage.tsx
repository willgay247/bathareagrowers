...
const PlotsPage = () => (
  <main>
    <section className="relative flex h-[40vh] md:h-[60vh] w-full items-center justify-center overflow-hidden">
      <img src={imageUrl("1-1-rotated.jpeg", { width: 1200, quality: 75 })} alt="Plots and land available" className="absolute inset-0 w-full h-full object-cover" loading="eager" decoding="async" />
