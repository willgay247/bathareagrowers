...
export const locations: Location[] = [
  { slug: "alice-park-community-garden", name: "Alice Park Community Garden", area: "Larkhall, Bath", address: "Alice Park, Larkhall, Bath", description: "Managed and gardened by volunteers, sharing skills and knowledge, Alice Park Community Garden in Larkhall aims to model community resilience and food self-sufficiency. It's also a social hub where local community members can gather.", image: "https://fgjdlgslkwfgfzidfpyz.supabase.co/storage/v1/object/public/cms-images/IMG_3660-e1718389959542.jpeg", upcomingEvents: [] },
